...
def files_mask2rle(path):
    ...
    for file in files:
        ...
        if fp == os.path.join(path, '.ipynb_checkpoints'):
            continue
...
#     program_path = './DeepLearning/Cancer'
#     csv_path = os.path.join(program_path, 'mask.csv')
#     mask_path = os.path.join(program_path, 'mask')
#     print(os.getcwd())
#     files_rle2mask(csv_path, mask_path)

    path = '/root/autodl-tmp/Blood/test/pred'
    files_mask2rle(path)
