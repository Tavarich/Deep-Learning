...
writer = SummaryWriter('/root/tf-logs/edsr')  # tensorboard 可视化 （路径需要自己修改）
...
if __name__ == "__main__":
    ...
    train_path = "/root/autodl-tmp/DIV2K/DIV2K_train_HR"   #训练集路径（路径需要自己修改）
    valid_path = "/root/autodl-tmp/DIV2K/DIV2K_valid_HR"   #测试集路径（路径需要自己修改）
